 ...
 *
 */
public class Dental_factura extends GenerateCode {
	...
	public void testNuevo() throws IOException {
		...
		String formulario = "factura"; // nombre del formulario *
