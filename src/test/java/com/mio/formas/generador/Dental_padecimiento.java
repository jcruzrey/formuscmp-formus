 ...
 *
 */
public class Dental_padecimiento extends GenerateCode {
	...
	public void testNuevo() throws IOException {
		...
		String formulario = "padecimiento"; // nombre del formulario *
		...
		forma.setName("padecimiento");
		forma.setView("padecimiento");
		forma.setTitle("Padecimiento");
		forma.setVersion("1.0");
		forma.setStatus("produccion");
		forma.setModule(modulo);
		forma.setBasket("basket");
		forma.setCreateable(true);
		forma.setTable("padecimiento");
		forma.setValidate(true);
		forma.setInstruction("Por favor complete la informacion de padecimiento del diente");
		forma.setUuid(generarToken());
		forma.setComment("Formulario para registrar los padecimientos");
