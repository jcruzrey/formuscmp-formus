 ...
 *
 */
public class Dental_plantilla extends GenerateCode {
	...
	public void testNuevo() throws IOException {
		...
		String formulario = "plantilla"; // nombre del formulario *
		...
		forma.setTable("plantilla");
		forma.setValidate(true);
		forma.setInstruction("Por favor complete la plantilla");
		forma.setUuid(generarToken());
		forma.setComment("Plantilla de receta Dental");
		...
		orden++;
		vistaCampo.setName("vista");
		vistaCampo.setFieldName("vista");
		vistaCampo.setCss("form-control");
		vistaCampo.setOrder(orden);
		vistaCampo.setComponentType("texto");
		vistaCampo.setReadOnly(false);
		vistaCampo.setHidden(false);
		vistaCampo.setRequired(true);
		vistaCampo.setShowInBasket(true);
		vistaCampo.setId(false);
		vistaCampo.setSearcheable(true);
		vistaCampo.setValidation(null);
		vistaCampo.setFormat(null);
		vistaCampo.setGroup("header");
		vistaCampo.setLength(4);
		vistaCampo.setDbFieldType("int");
		vistaCampo.setDecimals(0);
		vistaCampo.setPersistible(true);
		vistaCampo.setLabel("Vista");
		vistaCampo.setUuid(generarToken());
		vistaCampo.setComment("vista");
		vistaCampo.setAffects(null);
		vistaCampo.setFilter(null);
		vistaCampo.setEvents("*");
		vistaCampo.setOrigin(null);
		vistaCampo.setValue("");
