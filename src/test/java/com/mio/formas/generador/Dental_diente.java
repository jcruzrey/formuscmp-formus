 ...
 *
 */
public class Dental_diente extends GenerateCode{
	...
	public String Dientes(int inicio, int fin) {
	...
	public void testNuevo() throws IOException {
		...
		String formulario = "diente"; //nombre del formulario *
		...
		Field numeroCampo = new Field();
		Field colorCampo = new Field();
		Field imagenCampo = new Field();
		...
		forma.setPrefix("ODT");
		forma.setCommandName("diente");
		forma.setName("diente");
		forma.setView("vista");
		forma.setTitle("Diente de odontograma");
		forma.setVersion("1.0");
		forma.setStatus("produccion");
		forma.setModule("dental");
		forma.setBasket("basket");
		forma.setCreateable(true);
		forma.setTable("diente");
		forma.setValidate(true);
		forma.setInstruction("Por favor complete la informacion del diente");
		forma.setUuid(generarToken());
		forma.setComment("Formulario para registrar el estado de cada diente");
		...
		uuidpCampo.setComponentType("odontograma");
		...
		uuidpCampo.setLabel("Odontograma");
		...
		uuidpCampo.setOrigin("{\"origin\":\"tabla\",\"resource\":\"odontograma\",\"fields\":[{\"name\":\"nombre\", \"filter\":\"\"},{\"name\":\"uuid\", \"filter\":\"\"}]}");
		uuidpCampo.setValue("");
		
		
		orden++;
		numeroCampo.setName("numero");
		numeroCampo.setFieldName("numero");
		numeroCampo.setCss("form-select");
		numeroCampo.setOrder(orden);
		numeroCampo.setComponentType("lista");
		numeroCampo.setReadOnly(false);
		numeroCampo.setHidden(false);
		numeroCampo.setRequired(true);
		numeroCampo.setShowInBasket(true);
		numeroCampo.setId(false);
		numeroCampo.setSearcheable(true);
		numeroCampo.setValidation(null);
		numeroCampo.setFormat(null);
		numeroCampo.setGroup("header");
		numeroCampo.setLength(0);
		numeroCampo.setDbFieldType("int");
		numeroCampo.setDecimals(0);
		numeroCampo.setPersistible(true);
		numeroCampo.setLabel("Numero de diente");
		numeroCampo.setUuid(generarToken());
		numeroCampo.setComment("Numero de diente");
		numeroCampo.setAffects(null);
		numeroCampo.setFilter(null);
		numeroCampo.setEvents("*");
		numeroCampo.setOrigin("{\"origin\":\"recurso\",\"resource\":\"inlinevalues\",\"fields\":[{\"name\":\"" + Dientes(1,100) + "\"}]}");
		numeroCampo.setValue("");

		orden++;		
		colorCampo.setName("color");
		colorCampo.setFieldName("color");
		colorCampo.setCss("form-select");
		colorCampo.setOrder(orden);
		colorCampo.setComponentType("color");
		colorCampo.setReadOnly(false);
		colorCampo.setHidden(false);
		colorCampo.setRequired(true);
		colorCampo.setShowInBasket(true);
		colorCampo.setId(false);
		colorCampo.setSearcheable(true);
		colorCampo.setValidation(null);
		colorCampo.setFormat(null);
		colorCampo.setGroup("header");
		colorCampo.setLength(100);
		colorCampo.setDbFieldType("varchar");
		colorCampo.setDecimals(0);
		colorCampo.setPersistible(true);
		colorCampo.setLabel("Color");
		colorCampo.setUuid(generarToken());
		colorCampo.setComment("color");
		colorCampo.setAffects(null);
		colorCampo.setFilter(null);
		colorCampo.setEvents("*");
		colorCampo.setOrigin(null);
		colorCampo.setValue("");

		orden++;		
		imagenCampo.setName("imagen");
		imagenCampo.setFieldName("imagen");
		imagenCampo.setCss("form-control");
		imagenCampo.setOrder(orden);
		imagenCampo.setComponentType("texto");
		imagenCampo.setReadOnly(false);
		imagenCampo.setHidden(false);
		imagenCampo.setRequired(true);
		imagenCampo.setShowInBasket(true);
		imagenCampo.setId(false);
		imagenCampo.setSearcheable(true);
		imagenCampo.setValidation(null);
		imagenCampo.setFormat(null);
		imagenCampo.setGroup("header");
		imagenCampo.setLength(200);
		imagenCampo.setDbFieldType("varchar");
		imagenCampo.setDecimals(0);
		imagenCampo.setPersistible(true);
		imagenCampo.setLabel("Imagen");
		imagenCampo.setUuid(generarToken());
		imagenCampo.setComment("imagen");
		imagenCampo.setAffects(null);
		imagenCampo.setFilter(null);
		imagenCampo.setEvents("*");
		imagenCampo.setOrigin(null);
		imagenCampo.setValue("");
		...
		campos.add(obsCampo);
		campos.add(numeroCampo);
		campos.add(colorCampo);
		campos.add(imagenCampo);
