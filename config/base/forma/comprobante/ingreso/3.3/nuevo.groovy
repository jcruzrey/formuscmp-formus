import com.mio.formas.web.comando.NuevaForma;
...
class EjecutaNuevaForma {
    RespuestaForma ejecutar(empresa, nombreModulo, version, nombreForma, peticion, repoServicio, ejecutaDatos, formato) {
        NuevaForma.ejecutar(empresa, nombreModulo, version, nombreForma, peticion, repoServicio, ejecutaDatos, formato);
    }
}